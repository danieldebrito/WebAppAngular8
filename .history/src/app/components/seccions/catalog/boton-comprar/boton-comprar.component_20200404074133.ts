...
export class BotonComprarComponent implements OnInit {
  ...
  public carritoItemUpdate = {} as CarritoItem; // item a dar de alta
  ...
  updateCarritoItem() {
    this.carritoItemUpdate.idPedido = -1;
    this.carritoItemUpdate.idCliente = this.identity.idCliente;
    this.carritoItemUpdate.idArticulo = this.id_articulo;
    this.carritoItemUpdate.cantidad = this.cantidad;
    this.carritoItemUpdate.precioLista = this.articulo.precio_lista;

    this.carritoItemsService.updateCarritoItem(this.carritoItemUpdate);
  }
