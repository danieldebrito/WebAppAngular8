...
export class CarritoComponent implements OnInit {
  ...
  public async getPedidoClienteAbierto(idCliente: string) {
    this.pedidosService.traerpedidoAbierto(idCliente).subscribe(Response => {
      alert(Response.idPedido);
  ...
  public cerrarPedido() {
    ...
    // alert(this.getPedidoClienteAbierto(this.clienteLogueado.idCliente));

/*
    this.updateidPedidoCarritoItems(this.getPedidoClienteAbierto(this.clienteLogueado.idCliente));
*/
  }
